...
# OAuth2PasswordBearer is a class we import from FastAPI
# that we can instantiate by passing it the path that
# our users will send their email and password to so that
# they can authenticate. This class simply informs FastAPI
# that the URL provided is the one used to get a token.
# This route actually exists in our routes file
